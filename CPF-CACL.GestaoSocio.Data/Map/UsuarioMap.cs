...
namespace CPF_CACL.GestaoSocio.Data.Map
{
    public class UsuarioMap : IEntityTypeConfiguration<Usuario>
    {
        public void Configure(EntityTypeBuilder<Usuario> builder)
        {
            ...
            builder.Property(x => x.Nome).HasColumnType("varchar(150)").IsRequired(true);
            builder.Property(x => x.Email).HasColumnType("varchar(300)");
            builder.Property(x => x.Login).HasColumnType("varchar(100)").IsRequired(true);
            builder.Property(x => x.Senha).HasColumnType("text").IsRequired(true);
			builder.Property(x => x.Perfil).HasColumnType("varchar(20)").IsRequired(true);
