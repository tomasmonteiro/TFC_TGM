...
{
    public class PagamentoEmolumentoMap : IEntityTypeConfiguration<PagamentoEmolumento>
    {
        public void Configure(EntityTypeBuilder<PagamentoEmolumento> builder)
        {
            builder.ToTable("PagamentoEmolumento");
